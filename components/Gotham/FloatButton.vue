...
<template>
  <button
    ...
    :class="[
      'fixed z-50 md:relative btn btn-primary rounded-full max-md:btn-circle md:rounded md:inset-x-auto md:inset-y-auto mb-4 transition-transform ease-in-out duration-300',
