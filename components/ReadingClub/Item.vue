...
<template>
  <NuxtLink
    ...
    class="relative flex justify-between gap-2 items-center p-4 border-b before:content before:absolute before:bottom-0 before:left-0 before:w-0 before:h-[.2rem] before:bg-primary hover:before:w-full before:transition-all before:duration-300 hover:bg-base-300/30 hover:border-transparent transition duration-300"
  >
    <div>
      <p>
        {{ readingClub.name }}
